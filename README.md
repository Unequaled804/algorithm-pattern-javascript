...
本JavasScript版本基于原项目 [algorithm-pattern](https://github.com/greyireland/algorithm-pattern) 和的 Python3版本 [algorithm-pattern-python](https://github.com/dashidhy/algorithm-pattern-python)改编。
原项目使用 go 语言实现，目前已获 9k+ star。在原项目基础上，Python版项目添加了优先级队列，并查集，图相关算法等内容。基本覆盖了所有基础数据结构和算法，非常适合找工刷题的同学快速上手。

以下为原项目 README，目录部分增加了本项目的新内容。
